  ...
  Future<void> writeLog({
    ...
    try {
      ...
      if (targetEndpoint != null) {
        buf.writeln('[Forward To] $targetEndpoint');
      }
      if (requestDurationMs != null) {
        buf.writeln('[Duration] ${requestDurationMs}ms');
      }
      ...
      // 写入文件失败时不抛异常，避免影响代理主流程
      developer.log('[ProxyLogWriter] 写入日志文件失败: $e');
    }
  }
